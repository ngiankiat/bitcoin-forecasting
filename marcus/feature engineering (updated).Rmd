...
3. Twitter 
    ...
    + Sentiment analysis is not conducted due to the need to apply for twitter API, while python <code>Twint</code> can bypass this API, but when the team attempted in the usage of it, we realised there are some limitations with the package.
