...
* The purpose of using this data is to see if the volume of the tweets (capture social media attention) affects the prices of bitcoin.
...
```{r}
bitcoin_model <- subset(bitcoin_model, date>= "2013-10-01" & date <= "2020-11-26")
```
