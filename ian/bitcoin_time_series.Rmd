...
Source: [Tidy Forecasting with sweep](https://www.business-science.io/code-tools/2017/10/25/demo_week_sweep.html)
...
fit_arima <- auto.arima(bitcoin_price_ts)
...
fcast_tbl %>%
    ...
    # Aesthetics
    labs(title = "Bitcoin Prices Forecast: ARIMA", x = "", y = "Closing Price",
         subtitle = "subtitle") +
    scale_x_date(date_breaks = "1 year", date_labels = "%Y") +
    scale_y_continuous(labels = scales::dollar_format()) +
    scale_color_tq() +
