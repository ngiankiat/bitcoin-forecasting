...
stacked_model <- stacks() %>%
  ...
  # add_candidates(xgb_final_training_pred) %>%
  # add_candidates(svm_accuracy_final_training_pred) %>%
  # add_candidates(svm_roc_final_training_pred) %>%
  # add_candidates(rf_ranger_accuracy_final_training_pred) %>%
  # add_candidates(rf_ranger_roc_auc_final_training_pred) %>%
  # add_candidates(rf_randomForest_accuracy_final_training_pred) %>%
  # add_candidates(rf_randomForest_roc_auc_final_training_pred)
