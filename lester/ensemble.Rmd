...
collect_parameters(ensemble_model, "nnet_res")

# Make predictions with ensemble model
sample <- train %>% 
  select(date, future_return, future_return_sign) %>% 
  bind_cols(predict(ensemble_model, train))
```
