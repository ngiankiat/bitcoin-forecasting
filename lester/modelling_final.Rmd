...
# 13. Test Date
## 13.1 Fitting final model to testing data
```{r}
...
## 13.2 Plot bitcoin prices and buy/sell signal over time
```{r}
...
## 14.2 Extracting and Visualizing variable importance
See changes in variable importance overtime.
```{r}
# Plot chart of price, fill by split
